...
""",
        reply_markup=InlineKeyboardMarkup(
            [
                ...
                [
                    InlineKeyboardButton(
                        " قناتي الثانيهه •", url=f"https://t.me/{GROUP_SUPPORT}"
                    ),
                    InlineKeyboardButton(
                        "༺BR Team༻", url=f"https://t.me/v00r22"
                    ),
...
async def cbbasic(_, query: CallbackQuery):
    await query.edit_message_text(
        f"""🏮 ها هي الأوامر الأساسية:
 » #تشغيل»» 「اسم الأغنية / رابط」تشغيل الصوت mp3
 » #فيديو»» 「اسم / رابط الفيديو」 تشغيل الفيديو داخل المكالمة
